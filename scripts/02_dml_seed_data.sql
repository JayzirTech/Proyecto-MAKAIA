...
-- 3. EQUIPOS
INSERT INTO dim_teams (id_sport, name) VALUES 
...
-- 4. USUARIOS (Con variaciones de KYC y saldos)
INSERT INTO dim_users (first_name, last_name, email, phone_number, date_of_birth, kyc_status, account_balance) VALUES 
('Carlos', 'Mendoza', 'carlos.mendoza@email.com', '+573001234567', '1995-04-12', 'Verified', 150000.00),
('Ana', 'Gomez', 'ana.gomez@email.com', '+573109876543', '1998-08-25', 'Pending', 0.00),
('Luis', 'Martinez', 'luis.martinez@email.com', '+573205558899', '1990-11-03', 'Verified', 50000.00);

-- 5. MÉTODOS DE PAGO (Vinculados a usuarios)
INSERT INTO dim_payment_methods (id_user, method_type, provider_name, account_identifier, is_active) VALUES 
(1, 'E-Wallet', 'Nequi', '3001234567', TRUE),
(1, 'Credit Card', 'Bancolombia Visa', '**** **** **** 4589', TRUE),
(3, 'Bank Transfer', 'PSE - Davivienda', 'Cuenta Ahorros ****1122', TRUE);
...
-- 10. APUESTAS (TICKETS Y SELECCIONES)
